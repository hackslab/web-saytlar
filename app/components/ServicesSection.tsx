...
const services = [
  {
    ...
    description:
      "Premium dizayn va yuqori tezlikka ega zamonaviy veb-saytlar. Biz landing sahifalar, korporativ saytlar va murakkab web-ilovalarni yaratamiz.",
    price: "300$ dan",
    tag: "01",
  },
  {
    ...
    description:
      "iOS va Android platformalari uchun qulay va funksional mobil ilovalar. React Native texnologiyasi orqali cross-platform yechimlar.",
    price: "500$ dan",
    tag: "02",
  },
  {
    ...
    description:
      "Biznesingizni avtomatlashtirish uchun mukammal telegram botlar. Savdo, mijozlar bilan aloqa va boshqa jarayonlarni osonlashtiring.",
    price: "150$ dan",
    tag: "03",
  },
  {
    ...
    title: "CRM Tizimlar",
    description:
      "Biznes jarayonlarini boshqarish uchun individual CRM tizimlar. Xodimlar, mijozlar va savdolarni bir joyda nazorat qiling.",
    price: "400$ dan",
    tag: "04",
  },
  {
    ...
    title: "Brand & Design",
    description:
      "Brendingiz uchun unikal logotip va brandbook yaratish. Mijozlar xotirasida qoladigan vizual obrazni shakllantiramiz.",
    price: "100$ dan",
    tag: "05",
  },
];
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 py-20 lg:py-40">
            <div className="mb-32">
              ...
              <p className="text-muted-foreground text-lg max-w-md">
                Bizning professional jamoamiz sizning g'oyalaringizni raqamli
            ...
            <div className="flex flex-col gap-48">
              {services.map((service, index) => (
                ...
                >
                  <span
                    className={`absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-background border-2 border-primary transition-opacity duration-300 ${
                      activeService === service.id
                        ? "opacity-100"
                        : "opacity-0 group-hover:opacity-100"
                    }`}
                  />
                  <span className="text-sm font-mono text-primary mb-3 block tracking-wider">
                    {service.tag}
                  </span>
                  <h3
                  ...
                  <p
                    className={`text-2xl font-bold mt-4 transition-colors duration-300 ${
                      activeService === service.id
                        ? "text-primary"
                        : "text-foreground"
                    }`}
                  ...
                  <div
                    className={`mt-6 flex items-center text-primary transform transition-all duration-300 ${
                      activeService === service.id
          ...
          <div className="hidden lg:flex lg:w-1/2 sticky top-0 h-screen items-center justify-center self-start">
            <div
              className="relative w-full max-w-[550px] aspect-square overflow-hidden"

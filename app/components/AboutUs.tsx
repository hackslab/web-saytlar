...
const AboutUs: React.FC = () => {
  return (
    <section className="relative w-full py-20 bg-black text-white overflow-hidden">
      ...
      {/* Background Elements */}
      <div className="absolute top-0 right-0 w-1/3 h-full bg-gradient-to-l from-[#2b68c9]/5 to-transparent pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-1/3 h-full bg-gradient-to-r from-[#2b68c9]/5 to-transparent pointer-events-none" />
    </section>
  );
};
